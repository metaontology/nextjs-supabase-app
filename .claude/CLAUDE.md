...
- [`dev-checklist.md`](./rules/dev-checklist.md) - 작업 완료 전 필수 실행 체크리스트
...
6. 코드 변경 후 작업 완료 전 `lint` 실행 필수 (빌드 영향 변경 시 `build`도 실행)
7. API/비즈니스 로직 구현 시 Playwright MCP로 E2E 테스트 수행 필수
